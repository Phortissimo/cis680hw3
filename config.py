...
misc_arg.add_argument('--load_path', type=str, default='./model')
...
misc_arg.add_argument('--data_dir', type=str, default="C:/Users/Akshay Chandrasekhar/Documents/Akshay/Akshay's school stuff/CIS 680/hw3/Problem 2")
